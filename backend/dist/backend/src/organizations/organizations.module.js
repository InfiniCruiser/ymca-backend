...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [organizations_service_1.OrganizationsService, ymca_import_service_1.YMCAImportService],
        exports: [organizations_service_1.OrganizationsService, ymca_import_service_1.YMCAImportService, typeorm_1.TypeOrmModule],
    })
], OrganizationsModule);
