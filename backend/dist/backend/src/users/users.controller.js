...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get users by organization ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Users in organization', type: [user_entity_1.User] }),
    __param(0, (0, common_1.Param)('organizationId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "findByOrganization", null);
__decorate([
    (0, common_1.Get)('role/:role'),
    (0, swagger_1.ApiOperation)({ summary: 'Get users by role' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Users with specified role', type: [user_entity_1.User] }),
